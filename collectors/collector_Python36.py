...
# Length,Gateways,GatewayRouters,Clients,ClientRouters
        ...
        if architecture == 'XIAIPv6':
            ...
            print(f'{l[6]}, {l[10]}, {l[12]}, {l[14]}, {l[16]}, {tmean/okcnt}, {ecnt*100/tcnt}, {cpu_tmean/cpu_tcnt}, {cpu_end}')
    ...
    if(architecture == 'XIAIPv6'):
        spreadsheetWriter = pd.ExcelWriter('./Results/XIAIPv6.xlsx', engine='xlsxwriter')

    elif(architecture == 'IPv6'):
        spreadsheetWriter = pd.ExcelWriter('./Results/IPv6Results.xlsx', engine='xlsxwriter')
       
    results.to_excel(spreadsheetWriter, sheet_name='Filtered Packets', index=False)
